...
const JobDescriptions = ({ setActiveTab }) => {
  ...
  const handleAddJobDescription = () => {
    ...
    const newJobDescription = {
      ...
      title: jobTitle,
      description:
        "Job description content would be extracted from the file...",
    ...
    const fetchJobs = async () => {
      try {
        ...
        data.forEach((job) => {
          ...
          console.log("jobss", jobDescriptions);
          ...
          >
            <div className="p-5">
              ...
              <div className="flex justify-start items-start gap-2">
                ...
                {job.assigned && (
                  <div className="mt-2">
                    <span className="inline-block bg-blue-600 text-white border border-blue-400 text-xs px-2 py-1 rounded-full">
                      Assigned to you
                    </span>
                  </div>
                )}
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 mb-2">
                ...
                <span className="font-medium">
                  {jobDescriptions.find((job) => job.id === selectedJob)?.title}
                </span>
              </p>
